...
import {View, Image, Animated, StyleSheet, Dimensions, TouchableHighlight} from "react-native";
...
var ParallaxImage = React.createClass({
    ...
    handleLayout: function() {
        if (this.isLayoutStale) {
            (this._touchable || this._container.getNode()).measure(this.handleMeasure);
        }
    },
    ...
    render: function() {
        ...
        var {onPress, scrollY, parallaxFactor, style, imageStyle, overlayStyle, children, ...props} = this.props;
